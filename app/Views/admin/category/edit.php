            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url("admin/category/update/{$category['category_id']}") ?>" method="post">
                            <div class="form-group">
                                <label for="category_name">Category Name</label>
                                <input type="text" name="category_name"
                                       class="form-control <?= isset(session()->getFlashdata('validation')['category_name']) ? 'is-invalid' : '' ?>"
                                       id="category_name" value="<?= old('category_name') ?? $category['category_name'] ?? '' ?>" tabindex="1">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="category_description"
                                          ...
                                          rows="10"><?= old('category_description') ?? $category['category_description'] ?? '' ?></textarea>
                                <div class="invalid-feedback">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <p class="ml-2"><?= $category['category_name'] ?></p>
                        </div>
                        <div>
                            <p class="m-0"><strong>Description</strong></p>
                            <p class="ml-2"><?= $category['category_description'] ?></p>
                        </div>
                        <div>
                            <a class="btn btn-primary" role="button" aria-pressed="true"
                               href="<?= base_url('admin/category/edit/' . $category['category_id']) ?>">Edit</a>
                            <form onsubmit="return confirm('Are you sure?');" class="d-inline"
                                  id="frmDeleteCategory"
                                  action="<?= base_url("admin/category/delete/{$category['category_id']}") ?>"
                                  method="post">
                                <?= csrf_field() ?>

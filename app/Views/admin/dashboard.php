    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <!-- Admin Stats -->
                <?= view_cell('\App\Libraries\Admin::adminCount') ?>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <!-- Employee Stats -->
                <?= view_cell('\App\Libraries\Employee::employeeCount') ?>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <!-- Item stats -->
                <?= view_cell('\App\Libraries\Item::itemCount') ?>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Items</h4>
                        <div class="card-header-action">
                            <a href="<?= route_to('print_itemsList') ?>" class="btn btn-primary">Download PDF</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <?= view_cell('\App\Libraries\Item::itemList') ?>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
